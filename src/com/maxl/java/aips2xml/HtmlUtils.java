...
public class HtmlUtils {
	...
	static private String ListOfKeywordsFR[] = {"Principe actif","Excipient","Excipients",
		...
		"Conservation","Patients �g�s","Grossesse","Allaitement","Population spéciales","Absorption","Distribution","Métabolisme",
		"Elimination"};
	...
	public String sanitizeSection(int sectionX, String med_title, String language) {
		...
		if (sectionX>1) {
			...
			if (language.equals("de"))
				clean_title = med_title; // clean_title.replace("�","�");
			else if (language.equals("fr"))
		...
		html_str = html_str.replaceAll(">�</sup>", ">�</sup>");
